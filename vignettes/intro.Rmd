...
x = cat_match(cars_bad, cars_good, method = "jaccard", return_dists = TRUE, return_lists = 3)
x = cat_match(cars_bad, cars_good, method = "jaccard", return_dists = TRUE, return_lists = 3, pick_lists = TRUE)
