...
cat_match(messy_caterpillars$CaterpillarSpecies,clean_caterpillars$species,return_dists = T)
```

```{r using outputs cat_match example}
cat_match(messy_caterpillars$CaterpillarSpecies,clean_caterpillars$species,return_dists = T) %>% arrange(desc(dists))
```
